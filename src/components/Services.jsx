...
const services = [
  {
    ...
    description:
      "Get reliable, high-speed fiber connection for your home and business with unlimited data options.",
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "Secure, clear, and feature-rich digital telephony system built for modern business communication.",
    icon: (
      <svg
        className="w-8 h-8 text-blue-500"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Connect your offices and remote workforce securely with our state-of-the-art virtual private networks.",
    icon: (
      <svg
        className="w-8 h-8 text-blue-500"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Protect your operational infrastructure against digital threats with continuous network monitoring.",
    icon: (
      <svg
        className="w-8 h-8 text-blue-500"
        fill="none"
...
export default function Services() {
  return (
    <section
      id="services"
      className="bg-zinc-950 py-24 sm:py-32 border-t border-zinc-900"
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg text-zinc-400">
            Discover how we can transform your digital infrastructure with
            custom, reliable, and high-performance communication systems.
          </p>
        </div>
